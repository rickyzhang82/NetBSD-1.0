 ...
 */
#define AE_P0_CR	0x00	/* Command Register */

#define AE_P0_CLDA0	0x01	/* Current Local DMA Addr low (read) */
#define AE_P0_PSTART	0x01	/* Page Start register (write) */

#define AE_P0_CLDA1	0x02	/* Current Local DMA Addr high (read) */
#define AE_P0_PSTOP	0x02	/* Page Stop register (write) */

#define AE_P0_BNRY	0x03	/* Boundary Pointer */

#define AE_P0_TSR	0x04	/* Transmit Status Register (read) */
#define AE_P0_TPSR	0x04	/* Transmit Page Start (write) */

#define AE_P0_NCR	0x05	/* Number of Collisions Reg (read) */
#define AE_P0_TBCR0	0x05	/* Transmit Byte count, low (write) */

#define AE_P0_FIFO	0x06	/* FIFO register (read) */
#define AE_P0_TBCR1	0x06	/* Transmit Byte count, high (write) */

#define AE_P0_ISR	0x07	/* Interrupt Status Register */

#define AE_P0_CRDA0	0x08	/* Current Remote DMA Addr low (read) */
#define AE_P0_RSAR0	0x08	/* Remote Start Address low (write) */

#define AE_P0_CRDA1	0x09	/* Current Remote DMA Addr high (read) */
#define AE_P0_RSAR1	0x09	/* Remote Start Address high (write) */

#define AE_P0_RBCR0	0x0a	/* Remote Byte Count low (write) */

#define AE_P0_RBCR1	0x0b	/* Remote Byte Count high (write) */

#define AE_P0_RSR	0x0c	/* Receive Status (read) */
#define AE_P0_RCR	0x0c	/* Receive Configuration Reg (write) */

#define AE_P0_CNTR0	0x0d	/* frame alignment error counter (read) */
#define AE_P0_TCR	0x0d	/* Transmit Configuration Reg (write) */

#define AE_P0_CNTR1	0x0e	/* CRC error counter (read) */
#define AE_P0_DCR	0x0e	/* Data Configuration Reg (write) */

#define AE_P0_CNTR2	0x0f	/* missed packet counter (read) */
#define AE_P0_IMR	0x0f	/* Interrupt Mask Register (write) */

/*
 * Page 1 register offsets
 */
#define AE_P1_CR	0x00	/* Command Register */
#define AE_P1_PAR0	0x01	/* Physical Address Register 0 */
#define AE_P1_PAR1	0x02	/* Physical Address Register 1 */
#define AE_P1_PAR2	0x03	/* Physical Address Register 2 */
#define AE_P1_PAR3	0x04	/* Physical Address Register 3 */
#define AE_P1_PAR4	0x05	/* Physical Address Register 4 */
#define AE_P1_PAR5	0x06	/* Physical Address Register 5 */
#define AE_P1_CURR	0x07	/* Current RX ring-buffer page */
#define AE_P1_MAR0	0x08	/* Multicast Address Register 0 */
#define AE_P1_MAR1	0x09	/* Multicast Address Register 1 */
#define AE_P1_MAR2	0x0a	/* Multicast Address Register 2 */
#define AE_P1_MAR3	0x0b	/* Multicast Address Register 3 */
#define AE_P1_MAR4	0x0c	/* Multicast Address Register 4 */
#define AE_P1_MAR5	0x0d	/* Multicast Address Register 5 */
#define AE_P1_MAR6	0x0e	/* Multicast Address Register 6 */
#define AE_P1_MAR7	0x0f	/* Multicast Address Register 7 */

/*
 * Page 2 register offsets
 */
#define AE_P2_CR	0x00	/* Command Register */
#define AE_P2_PSTART	0x01	/* Page Start (read) */
#define AE_P2_CLDA0	0x01	/* Current Local DMA Addr 0 (write) */
#define AE_P2_PSTOP	0x02	/* Page Stop (read) */
#define AE_P2_CLDA1	0x02	/* Current Local DMA Addr 1 (write) */
#define AE_P2_RNPP	0x03	/* Remote Next Packet Pointer */
#define AE_P2_TPSR	0x04	/* Transmit Page Start (read) */
#define AE_P2_LNPP	0x05	/* Local Next Packet Pointer */
#define AE_P2_ACU	0x06	/* Address Counter Upper */
#define AE_P2_ACL	0x07	/* Address Counter Lower */
#define AE_P2_RCR	0x0c	/* Receive Configuration Register (read) */
#define AE_P2_TCR	0x0d	/* Transmit Configuration Register (read) */
#define AE_P2_DCR	0x0e	/* Data Configuration Register (read) */
#define AE_P2_IMR	0x0f	/* Interrupt Mask Register (read) */
...
/* bit encoded aliases */
#define AE_CR_PAGE_0	0x00 /* (for consistency) */
#define AE_CR_PAGE_1	0x40
#define AE_CR_PAGE_2	0x80
